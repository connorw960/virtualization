...
#line 132 "../kern/init.c"
#ifndef VMM_GUEST
	// Lab 4 multiprocessor initialization functions
	mp_init();
	lapic_init();
#endif
#line 142 "../kern/init.c"

	// Lab 4 multitasking initialization functions
	pic_init();
#line 147 "../kern/init.c"
#ifndef VMM_GUEST  // Does not work in guest mode
	// Lab 6 hardware initialization functions
	time_init();
	pci_init();
#endif 
#line 154 "../kern/init.c"

	// Acquire the big kernel lock before waking up APs
	// Your code here:
#line 158 "../kern/init.c"
	lock_kernel();
#line 160 "../kern/init.c"

#line 162 "../kern/init.c"
#ifndef VMM_GUEST
	// Starting non-boot CPUs
	boot_aps();
#endif
#line 170 "../kern/init.c"

#line 172 "../kern/init.c"


#line 176 "../kern/init.c"

	// Start fs.
	ENV_CREATE(fs_fs, ENV_TYPE_FS);
#line 187 "../kern/init.c"
...
#else
	// Touch all you want.
#line 194 "../kern/init.c"
#if defined(TEST_EPT_MAP)
	test_ept_map();
#endif
#line 198 "../kern/init.c"

#line 200 "../kern/init.c"
	ENV_CREATE(user_icode, ENV_TYPE_USER);
#line 214 "../kern/init.c"
#endif // TEST*
#line 217 "../kern/init.c"

	// Should not be necessary - drains keyboard because interrupt has given up.
	kbd_intr();
#line 221 "../kern/init.c"

#line 223 "../kern/init.c"
	// Schedule and run the first user environment!
	sched_yield();
#line 240 "../kern/init.c"
}

#line 243 "../kern/init.c"
...
mp_main(void)
{
	...
	//
	// Your code here:
#line 293 "../kern/init.c"
	lock_kernel();
	sched_yield();     // start running processes
#line 300 "../kern/init.c"
}
#line 302 "../kern/init.c"
...
_panic(const char *file, int line, const char *fmt,...)
{
	...
	va_start(ap, fmt);
#line 328 "../kern/init.c"
	cprintf("kernel panic on CPU %d at %s:%d: ", cpunum(), file, line);
#line 332 "../kern/init.c"
	vcprintf(fmt, ap);
	cprintf("\n");
	va_end(ap);
