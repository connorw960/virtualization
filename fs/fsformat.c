...
#define FLAG_SBIN 3
#define FLAG_ROOT 0
#line 43 "../fs/fsformat.c"
#define FLAG_VMM 4
#line 45 "../fs/fsformat.c"
...
main(int argc, char **argv)
{
	...
	struct Dir bin, sbin;
	struct File *b, *sb;
#line 293 "../fs/fsformat.c"
	struct Dir vmm;
	struct File *v;
#line 296 "../fs/fsformat.c"
...
#line 316 "../fs/fsformat.c"
	v = diradd(&root, FTYPE_DIR, "vmm");
	startdir(v, &vmm);
#line 319 "../fs/fsformat.c"
	...
	for (i = 3; i < argc; i++) {
		if(strcmp("-b", argv[i]) == 0) {
			...
			flag = FLAG_SBIN;
			continue;
#line 328 "../fs/fsformat.c"
		} else if(strcmp("-g", argv[i]) == 0) {
			flag = FLAG_VMM;
			continue;
#line 332 "../fs/fsformat.c"
		}
		...
		case FLAG_SBIN:
			...
			break;
#line 345 "../fs/fsformat.c"
		case FLAG_VMM:
			writefile(&vmm, argv[i]);
			break;
#line 349 "../fs/fsformat.c"
		}
	}
	
	finishdir(&bin);
	finishdir(&sbin);
#line 355 "../fs/fsformat.c"
	finishdir(&vmm);
#line 357 "../fs/fsformat.c"
	finishdir(&root);
	finishdisk();
	return 0;
}
